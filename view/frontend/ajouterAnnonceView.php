...
<form action="" method="post" enctype="multipart/form-data">
    <div class="container inscription">
        ...
        <textarea style="width:100%" cols="80" rows="4" placeholder="Description........" name="description"
            required> </textarea>
        ...
        <input class="form-control-file border" type="file" name="image" placeholder=" Choisir une image">
        <p>
        </p>
