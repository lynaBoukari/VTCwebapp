...
<section class="mb-4">
    ...
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">Vous avez des questions ? N'hesitez pas à nous contacter directement. Notre équipe s'occupera de vous trés prochainement.</p>
