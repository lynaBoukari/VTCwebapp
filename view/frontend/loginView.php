...
<div id="Loginmodal" class="modal">
    ...
    <form class="modal-content animate" id="loginForm" action="" method="post">
        ...
        <div class="container containerLogin">
            ...
            <input placeholder="Entrez username" name="usernameLogin" type="text" required
                style="width:100%;padding:0.5rem;margin: 0.5rem 0 0.5rem 0; display: inline-block; border:none;background:#f1f1f1; ">
